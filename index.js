...
const password = process.env.PASSWORD || "SafoTheBot";

const page_404 = {
    "heading": "404",
    "content": `<a class="text-decoration-none text-dark" href="/"><div class="container"><h1>404 - Page Not Found</h1><p><i>Unable to find your pasted code maybe it doesn't exists!</i></p><span class="text-muted small">Back To Home</span></div></a>`,
    "footer": true
};
const page_500 = {
    "heading": "500",
    "content": `<a class="text-decoration-none text-dark" href="/"><div class="container"><h1>500 - Unknown Error</h1><p><i>An unknown error has occurred. Contact the developer with the url to fix it. Inconvenience is strictly regretted.</i></p><span class="text-muted small">Back To Home</span></div></a>`,
    "footer": true
};
...
async function getPage(data, heading = "paste") {
